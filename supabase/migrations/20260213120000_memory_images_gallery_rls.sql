-- Supabase CLI migrations: aligns memory_images SELECT/INSERT RLS with app (anon gallery + browser upload).
-- Equivalent to supabase/repair_memory_images_insert_policy.sql
